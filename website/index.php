...
<div style="text-align:center; margin-top: 40px; margin-bottom: 40px;">
  <img class="img-fluid" src="images/rec.jpg" style="align-items: center; margin: auto; display: block; margin-bottom: 10px;">
        <h4 style="font-size:24px;padding:4px;font-weight: 300px; font-family: Georgia,'Montserrat', sans-serif, cursive; letter-spacing: 0.5px; display: block;">Want to be one of the MECAns? if so, don't hesitate and apply now!</h4>
  <button onclick="myFunction()" class="w3-btn w3-dark-grey" style="font-size:22px;padding:12px 75px;background-color: #424242 !important;border: 2px solid white;
    border-radius: 5px;font-family: 'Concert One', cursive; letter-spacing: 6px; align-items: center; margin: auto;">APPLY NOW!</button>
  </div>
